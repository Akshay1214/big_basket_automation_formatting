...
for product in products:
    ...
    link = product.find_element(By.CSS_SELECTOR, '.prod-name > a').get_attribute("href")
    try:
    ...
    result.append([pname, delivery, link, discount_price,
...
headers = ["Product Name", "Devlivery Date", "Links", "Discount Price", "Original Price", "Rating", "Discount Percent"]
...
for x in col_c[1:]:
    ...
    driver.get(temp)
    time.sleep(3)
    bname = driver.find_element(By.CSS_SELECTOR, '#title > a').text
    ws1.append([bname])
